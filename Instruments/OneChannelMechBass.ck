...
public class OneChannelMechBass extends MultiStringInstrument
{
    ...
    fun int init( OscRecv input, FileIO file )
    {
        ...
        osc_patterns<<"/MechBass/noteoff,ii";
        ...
        osc_patterns<<"/MechBass/pluck,i";
        osc_patterns<<"/MechBass/position,ii";
        osc_patterns<<"/MechBass/clamp,ii";
        osc_patterns<<"/MechBass/damp,i";
